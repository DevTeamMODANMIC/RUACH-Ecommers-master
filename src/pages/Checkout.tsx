...
const lagosShippingOptions = [
  {
    id: "lagos-mainland-1",
    name: "Lagos Mainland 1",
    price: 1500,
    description: "Allen Avenue, Opebi, Toyin Ikeja",
  },
  {
    id: "lagos-mainland-2",
    name: "Lagos Mainland 2",
    price: 2000,
    description: "Computer village, Alausa, Oregun Ikeja",
  },
  {
    id: "lagos-mainland-3",
    name: "Lagos Mainland 3",
    price: 3000,
    description: "Omole phase 1 & 2, Magodo, Ogudu, Ojota, Oko oba, Agege",
  },
  {
    id: "lagos-mainland-4",
    name: "Lagos Mainland 4",
    price: 3500,
    description:
      "Surulere, Yaba, Bariga, Gbagada, Ajao estate, Anthony, Ikosi, Ketu, Iju ishaga, Oshodi, Maryland, Mushin, Ilupeju",
  },
  {
    id: "lagos-mainland-5",
    name: "Lagos Mainland 5",
    price: 4500,
    description:
      "Iyana ipaja, Ikotun, Egbeda, Abule Egba, Amuwo odofin, Igando, Festac, Meiran, Ayobo, Ago palace way, Satellite town, idimu, Ijaiye, Ejigbo",
  },
  {
    id: "lagos-mainland-6",
    name: "Lagos Mainland 6",
    price: 5000,
    description: "Ojokoro, Ikorodu, Akute, Alagbado",
  },
  {
    id: "lagos-island-1",
    name: "Lagos Island 1",
    price: 4500,
    description: "Eko idumota, IKOYI, Victoria island, Oniru",
  },
  {
    id: "lagos-island-2",
    name: "Lagos Island 2",
    price: 4500,
    description: "Lekki, Agungi, Ikate, Ologolo",
  },
  {
    id: "lagos-island-3",
    name: "Lagos Island 3",
    price: 3000,
    description: "CHEVRON, VGC, ORCHID, IKOTA, AJAH, IGBO-EFON",
  },
...
const otherShippingOptions = [
  {
    ...
    price: 6000,
    description:
      "Tracked delivery outside Lagos. 3-5 working days. Price may be higher for orders over 2kg.",
  },
  {
    ...
    price: 3000,
    description:
      "Outside Nigeria. Price determined by weight. Agent will contact you.",
  },
  {
    id: "bus-park-delivery",
    name: "Bus Park Delivery",
    price: 1000,
    description: "",
  },
];
...
export default function CheckoutPage() {
  ...
  const [lagosShippingOptionId, setLagosShippingOptionId] =
    useState("lagos-mainland-1");
  const [otherShippingOptionId, setOtherShippingOptionId] =
    useState("gig-logistics");
  ...
  const shippingCost =
    deliveryType === "lagos"
      ? lagosShippingOptions.find(
          (option) => option.id === lagosShippingOptionId,
        )?.price || 0
      : otherShippingOptions.find(
          (option) => option.id === otherShippingOptionId,
        )?.price || 0;
          ...
          <div className="flex items-center justify-center space-x-8">
            {[
              ...
              <div key={stepItem.number} className="flex items-center">
                ...
                {stepItem.number < 4 && (
                  <div className="w-16 h-px bg-muted ml-4" />
                )}
              </div>
            ))}
          </div>
          ...
          <div className="lg:col-span-2">
                ...
                <CardContent className="space-y-4">
                        ...
                        >
                          <div className="flex justify-between">
                            <div>
                              ...
                              <div className="text-sm text-muted-foreground">
                                Outside Lagos or International
                              </div>
                            </div>
                          </div>
                        </Label>
                  ...
                  {deliveryType === "lagos" && (
                    <div className="mt-4">
                      ...
                      <RadioGroup
                        value={lagosShippingOptionId}
                        onValueChange={setLagosShippingOptionId}
                        className="mt-3"
                      >
                  ...
                  {deliveryType === "other" && (
                    <div className="mt-4">
                      ...
                      <RadioGroup
                        value={otherShippingOptionId}
                        onValueChange={setOtherShippingOptionId}
                        className="mt-3"
                      >
            ...
            <div className="flex justify-between mt-6">
              <Button
                variant="outline"
                onClick={() =>
                  step > 1 ? setStep(step - 1) : navigate("/cart")
                }
              >
