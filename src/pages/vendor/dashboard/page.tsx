...
export default function VendorDashboardHome() {
  ...
  if (isNewVendor) {
    return (
      <div className="space-y-8">
        {/* Welcome Section for New Vendors */}
        <div className="text-center py-12">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            You're all set to start selling. Add your first product to get started and begin reaching customers.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            <CardContent className="p-6 text-center">
              <Plus className="h-10 w-10 text-blue-600 mx-auto mb-4" />
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <Package className="h-10 w-10 text-purple-600 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">Manage Store</h3>
              <p className="text-sm text-gray-600 mb-4">Customize your store settings and information</p>
              <Button asChild variant="outline" size="sm">
                <Link to="/vendor/stores">Manage</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">Monitor your sales and customer engagement</p>
              <Button asChild variant="outline" size="sm">
                <Link to="/vendor/dashboard">View Stats</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, index) => (
          <Card key={index}>
            <CardContent className="p-6">
              <div className="flex items-center">
                <div className={`rounded-full w-12 h-12 ${stat.bgColor} flex items-center justify-center`}>
            ...
            <Button asChild variant="outline" className="h-auto p-4">
              <Link to="/vendor/dashboard/products/new">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-500">Add a new product to your store</div>
                </div>
              </Link>
            </Button>
            ...
            <Button asChild variant="outline" className="h-auto p-4">
              <Link to="/vendor/dashboard/products">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-500">Edit and organize your products</div>
                </div>
              </Link>
            </Button>
            ...
            <Button asChild variant="outline" className="h-auto p-4">
              <Link to="/vendor/dashboard/orders">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-500">Track and manage your orders</div>
                </div>
              </Link>
            </Button>
          </div>
