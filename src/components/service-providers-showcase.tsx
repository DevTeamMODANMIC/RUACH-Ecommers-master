      ...
      >
        ...
        <div className="relative h-48 bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
          ...
          {hoveredProviderId === provider.id && (
            <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center gap-2 transition-opacity duration-300">
              <button className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-blue-500 hover:text-white transition-colors">
        ...
        <CardFooter className="pt-0 mt-auto space-y-2">
          <div className="flex gap-2 w-full">
            <Link to={`/services/marketplace?provider=${provider.id}`} className="flex-1">
