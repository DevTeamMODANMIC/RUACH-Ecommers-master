...
const slides = [
  {
    ...
    image: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=500&auto=format&fit=crop&q=60",
    cta: "Shop Now",
    ctaLink: "/shop",
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1661331827641-c6302f69d3f7?w=500&auto=format&fit=crop&q=60",
    cta: "View Collection",
    ctaLink: "/shop",
  },
  {
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center md:items-start z-10">
            ...
            >
              <span className="inline-block px-4 py-1 bg-green-600 text-white text-xs md:text-sm rounded-full mb-4 shadow-lg">
                Limited Time Offers
              </span>
              ...
              <p className="hidden md:block text-white/80 max-w-xl mb-6 text-lg">{slide.description}</p>
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${
              index === currentSlide ? "bg-green-500 w-8 sm:w-10" : "bg-white/50 hover:bg-white/80"
            }`}
