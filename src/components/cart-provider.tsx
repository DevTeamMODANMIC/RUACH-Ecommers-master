...
export function CartProvider({ children }: { children: React.ReactNode }) {
  ...
  const addToCart = (item: CartItem, product?: Product) => {
    // Include vendorId if available from product or item
        ...
        return prevItems.map((i) =>
          i.productId === item.productId
            ? {
                ...
                vendorId: itemWithVendor.vendorId,
              }
            : i,
        );
      } else {
        return [...prevItems, itemWithVendor];
      }
    });
  };
